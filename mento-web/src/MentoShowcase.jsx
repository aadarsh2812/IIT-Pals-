    ...
    >
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 68 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <img src="/Atomic minds logo.webp" alt="Atomic Minds" style={{ height: 36, objectFit: "contain", borderRadius: 6 }} />
    ...
    <section ref={ref} style={{ minHeight: "100vh", background: "#06060A", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden", padding: "100px 24px 60px" }}>
      ...
      <motion.div style={{ y, opacity, position: "relative", zIndex: 10, textAlign: "center", maxWidth: 900 }}>
        ...
        <motion.div
          ...
          style={{ display: "inline-flex", alignItems: "center", gap: 8, border: "1px solid rgba(230,57,70,0.3)", background: "rgba(230,57,70,0.08)", borderRadius: 100, padding: "6px 16px", marginBottom: 32 }}
        >
          <span style={{ width: 6, height: 6, borderRadius: "50%", background: "#E63946", animation: "pulse 2s infinite" }} />
          <img src="/Atomic minds logo.webp" alt="Atomic Minds" style={{ height: 18, objectFit: "contain", borderRadius: 3 }} />
    ...
    <footer style={{ borderTop: "1px solid rgba(255,255,255,0.06)", background: "#06060A", padding: "32px 24px" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <img src="/Atomic minds logo.webp" alt="Atomic Minds" style={{ height: 28, objectFit: "contain", borderRadius: 4 }} />
          <span style={{ fontFamily: "Syne", fontWeight: 800, fontSize: 16, color: "#fff" }}>Mento</span>
